public class Various extends Pet
{
  ...
  public Various(String name, int age, String colour, char gender, String comment, String specie){
  ...
  public Pet copy(){
    return new Various(super.getName(),getAge(),getColour(),getGender(),getComment(),specie);
  }
  public String toString(){
    return "Various: "+super.toString()+", specie: "+specie+"/n";
  }
