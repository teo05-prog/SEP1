public class Rodent extends Pet
{
  ...
  public Rodent(String name, int age, String colour, char gender, String comment,boolean doesItBite){
  ...
  public Pet copy(){
    return new Rodent(super.getName(),getAge(),getColour(),getGender(),getComment(),getDoesItBite());
  }
  public String toString(){
    return "Rodent: "+super.toString()+", does it bite?: "+doesItBite+"/n";
  }
